package  
{
	...
	public class MainMenu extends World 
	{
		...
		private var _bigLogo:BigGameLogoStamp;
		private var _bigSponsor:CenterLogoSplash;
		private var _sponsor:SponsorLogoStamp;
		
		public static var firstRun:Boolean = true;
		public function MainMenu(from:String) 
		{
			...
			level = new Level("Main Menu",from);
		...
		override public function begin():void 
		{
			...
			*/
			...
			_bigLogo = StaticCache.bigLogo;
			_bigLogo.place(320, 120);
			add(_bigLogo );
			...
			_bigSponsor = StaticCache.bigSponsor;
			//_bigSponsor.place(320, 190);
			add(_bigSponsor);
